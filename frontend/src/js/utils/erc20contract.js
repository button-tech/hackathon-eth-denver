...
//     return BL.Ethereum.contract.getInstance(ABI, address);
// };
//
// async function getTokenBalance(contractAddress, userAddress) {
//     return await _Ethereum.contract.get(createInstance(contractAddress), "balanceOf", userAddress, [userAddress]);
// }
//
// async function sendToken(privateKey, contractAddress, receiver, amount) {
//     return await BL.Ethereum.contract.set(privateKey, createInstance(contractAddress), "transfer", [receiver, amount]);
// }